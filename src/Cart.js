...
import { getProducts, setCartThunks, destroyCartThunks, updateThunks } from './redux/store.js';
        ...
        <ul>
          {
            (items.map( item =>
               ...
               <li key='quantity'>Quantity: {item.quantity}</li>
                <li key='price'>Cost: ${item.product.price}</li>
